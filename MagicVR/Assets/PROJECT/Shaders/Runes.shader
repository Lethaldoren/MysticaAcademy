	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float fbtotaltiles13 = 8.0 * 3.0;
				// Offsets for cols and rows of Flipbook Texture
				float fbcolsoffset13 = 1.0f / 8.0;
				float fbrowsoffset13 = 1.0f / 3.0;
				// Speed of animation
				float fbspeed13 = _Time[ 1 ] * 0.0;
				// UV Tiling (col and row offset)
				float2 fbtiling13 = float2(fbcolsoffset13, fbrowsoffset13);
				// UV Offset - calculate current tile linear index, and convert it to (X * coloffset, Y * rowoffset)
				// Calculate current tile linear index
				float fbcurrenttileindex13 = round( fmod( fbspeed13 + 0.0, fbtotaltiles13) );
				fbcurrenttileindex13 += ( fbcurrenttileindex13 < 0) ? fbtotaltiles13 : 0;
				// Obtain Offset X coordinate from current tile linear index
				float fblinearindextox13 = round ( fmod ( fbcurrenttileindex13, 8.0 ) );
				// Multiply Offset X by coloffset
				float fboffsetx13 = fblinearindextox13 * fbcolsoffset13;
				// Obtain Offset Y coordinate from current tile linear index
				float fblinearindextoy13 = round( fmod( ( fbcurrenttileindex13 - fblinearindextox13 ) / 8.0, 3.0 ) );
				// Reverse Y to get tiles from Top to Bottom
				fblinearindextoy13 = (int)(3.0-1) - fblinearindextoy13;
				// Multiply Offset Y by rowoffset
				float fboffsety13 = fblinearindextoy13 * fbrowsoffset13;
				// UV Offset
				float2 fboffset13 = float2(fboffsetx13, fboffsety13);
				// Flipbook UV
				half2 fbuv13 = float2( 0,0 ) * fbtiling13 + fboffset13;
				// *** END Flipbook UV Animation vars ***
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = tex2D( _Runes, fbuv13 ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=17600
222;73;1301;655;889.9312;267.2358;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;5;-28.73029,122.3962;Inherit;False;Constant;_Float0;Float 0;0;0;Create;True;0;0;False;0;0.5;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;6;-175.9312,-108.2358;Inherit;True;Property;_Runes;Runes;0;0;Create;True;0;0;False;0;-1;34e59631601c09342918ad367beb4c66;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCFlipBookUVAnimation;13;-495.9312,-72.23584;Inherit;False;0;0;6;0;FLOAT2;0,0;False;1;FLOAT;8;False;2;FLOAT;3;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;247.5495,-68.54485;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;3;Runes;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;0;Forward;7;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;2;0;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;10;Surface;1;  Blend;0;Two Sided;1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;0;Built-in Fog;0;Meta Pass;0;Vertex Position,InvertActionOnDeselection;1;0;4;True;True;True;False;False;;0
WireConnection;6;1;13;0
WireConnection;1;2;6;0
WireConnection;1;4;5;0
ASEEND*/
//CHKSM=C9AC070619056C6A50008732F19886636DF5BDDC