	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float dotResult35 = dot( ( -1.0 * SafeNormalize(_MainLightPosition.xyz) ) , WorldSpaceViewDirection );
				float temp_output_40_0 = ( ( 1.0 - saturate( ( dotResult35 + 0.2 ) ) ) + 0.2 );
				float fresnelNdotV41 = dot( WorldSpaceNormal, WorldSpaceViewDirection );
				float fresnelNode41 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV41, 4.0 ) );
				...
				float dotResult48 = dot( SafeNormalize(_MainLightPosition.xyz) , tangentToWorldDir21 );
				...
				float3 normalizeResult51 = normalize( ( WorldSpaceViewDirection + SafeNormalize(_MainLightPosition.xyz) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float dotResult35 = dot( ( -1.0 * SafeNormalize(_MainLightPosition.xyz) ) , ase_worldViewDir );
				float temp_output_40_0 = ( ( 1.0 - saturate( ( dotResult35 + 0.2 ) ) ) + 0.2 );
				...
				float3 normalizeResult51 = normalize( ( ase_worldViewDir + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult52 = dot( normalizeResult51 , tangentToWorldDir21 );
				float temp_output_53_0 = ( temp_output_46_0 * dotResult52 );
				float4 temp_cast_1 = (( _SpecularStrength * step( ( 1.0 - _SpecularSize ) , (0.0 + (temp_output_53_0 - 0.0) * (1.0 - 0.0) / (1.0 - 0.0)) ) )).xxxx;
				float4 temp_cast_2 = (0.01).xxxx;
...
/*ASEBEGIN
Version=17700
280;73;1027;655;-1623.995;8.537323;1;True;False
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;98;3521.324,-297.3222;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FogAndAmbientColorsNode;103;3491.82,-377.1339;Inherit;False;unity_AmbientSky;0;1;COLOR;0
...
Node;AmplifyShaderEditor.SamplerNode;58;-67.48976,972.5687;Inherit;True;Property;_DabTexture;DabTexture;5;1;[HideInInspector];Create;True;0;0;False;0;-1;c7e5d971600b65044ab050fd08857719;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;111;2382.997,-424.7117;Inherit;False;Constant;_Float5;Float 5;9;0;Create;True;0;0;False;0;10;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;30;-2375.754,-451.1744;Inherit;False;True;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=D6D25787802DF7E7D17D7020A20030092BFB9E3C